...
exact bundled Skill, extension, four-tool allowlist, and Host bindings. Start
records a process-identity receipt and refuses to reuse a dead or mismatched
session. Neither command is a provider tool or an acceptance claim.
