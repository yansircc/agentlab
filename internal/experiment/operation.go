...
func Open(root, id string) (*Operation, error) {
	...
	return &Operation{root: root, id: id, dir: dir, ledger: ledger.Open(filepath.Join(dir, "events.jsonl")), artifacts: artifact.NewStore(filepath.Join(root, "artifacts"))}, nil
}

func (o *Operation) mutate(action func(*state) error) (resultErr error) {
