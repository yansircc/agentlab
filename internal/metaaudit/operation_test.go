...
func auditFixture(t *testing.T) (string, *run.Operation, run.EvidenceRef) {
	...
	inputs := experiment.RunInputs{Harness: put("harness"), Trial: put("trial"), Candidate: put("candidate"), Adapter: put("adapter"), OracleSet: put("oracles"), Fixture: fixture, FixtureReset: reset, EvidencePolicy: put("evidence"), StopPolicy: put("policy"), WorkerRuntime: put("runtime"), Environment: put("environment")}
